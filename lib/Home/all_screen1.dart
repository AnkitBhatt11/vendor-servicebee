...
import '../main.dart';
import 'all_screen2.dart';

//import 'package:flutter_google_places/flutter_google_places.dart';
import 'package:google_maps_webservice/places.dart';

class AllScreen1 extends StatefulWidget {
  final void Function(bool) callback;

  const AllScreen1({Key? key, required this.callback}) : super(key: key);

  @override
  _AllScreen1State createState() => _AllScreen1State();
}

class _AllScreen1State extends State<AllScreen1> {
  bool isAll = true;
  bool isHealth = false;
  bool isNews = false;
  bool isCancer = false;
  ...
  List<sub_category> list = List.empty();
 ...
 var badgeicon;
        ...
        ? Column(
            children: [
              GestureDetector(
                onTap: () => {
                  setState(() {
                    ConstanceData.sub_category_id = current.id;
                    ConstanceData.fragNav?.putPosit(key: 'AllScreen2');
                  }),
                },
                child: Card(
                  shape: RoundedRectangleBorder(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                fit: BoxFit.fill,
                                image: NetworkImage(
                                  'https://growgraphics.xyz/service-bee/public/${current.sc_image}',
                                ),
                              ),
                            ),
                          ),
  ...
  void fetchSubCategory() {
    ...
    access_network().get_sub_category(ConstanceData.category_id).then((_) {
      if (mounted) {
        setState(() {
          list = _;
        });
  ...
  //                                       counterText: '',
  //                                       hintText:
  //                                           "Pincode/Form-To/Within City As per L3",
  //                                       contentPadding: EdgeInsets.all(3.0),
  //                                       focusedBorder: InputBorder.none,
  //                                       enabledBorder: InputBorder.none,
  //                                       errorBorder: InputBorder.none,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    StatefulBuilder(builder: (context, _) {
                                      return GestureDetector(
                                        onTap: () async {
                                          final result = _handlePressButton();
